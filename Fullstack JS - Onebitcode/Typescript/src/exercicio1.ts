...
( name: string, pilot: string, crewLimit: number, crew: [] = [], inMission: boolean = false)
{
  const spaceship = {
    name, 
    pilot, 
...
function addCrew(member: string, spaceship: { name: string, crewLimit: number, crew: string[] }){
...
function sendMission(spaceship: {name: string, crewLimit : number, crew: string[], inMission: boolean}){
